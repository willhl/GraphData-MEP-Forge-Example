...
const browserIconsPath = path.join(__dirname, '../src/client/components/D3Visualization/components/icons')
const browserModulesPath = path.join(__dirname, '../src/client/components/D3Visualization/')
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      title: 'HL MEP Design Console | DEV',
      filename: 'index.html',
      viewport: [
  ...
  module: {
    ...
    rules: [
      ...
      },
      {
        ...
        include: [path.resolve(browserModulesPath, 'modules')],
      ...
      },
      {
        ...
        exclude: [path.resolve(browserIconsPath, 'icons')]
      },
      {
        test: /\.svg$/,
        loader: 'raw-loader',
        include: [path.resolve(browserIconsPath, 'icons')]
      },
